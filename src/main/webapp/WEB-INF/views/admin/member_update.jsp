...
<form name="f" action="/admin/members/update" method="POST">
	...
	<div class="btn-group me-2">
		...
		<button onclick="location.href='/admin/members'" type="button" class="btn btn-sm btn-outline-secondary">돌아가기</button>
	</div>
</form>
</main>
</body>
